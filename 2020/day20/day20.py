...
# there can only be one match, record it as the left top corner piece
...
# find sea monsters via regex
#def build_regex(line):
#    # offsets are taken from the length of a line
#    w = len(line)
#    pattern = "#" + "." * (w - 19)
#    pattern += "#....##....##....###" + "." * (w - 19)
#    pattern += "#..#..#..#..#..#"
...
#regex = build_regex(image[0])
#variations = get_variations(image)
#for variation in variations:
#    monsters = len(re.findall(regex, "".join(variation)))
#    if monsters > 0:
#       total = "".join(variation).count("#")
#        roughness = total - (monsters * 15)
#       print(f"Answer 2 via regex, doesn't work: {roughness}")
